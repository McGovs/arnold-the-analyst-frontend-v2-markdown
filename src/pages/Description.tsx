      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-gray-700 mt-6">
            Ready to use Arnold on client data? We can set up your GA4 BigQuery export, connect it to Arnold, and fine-tune according to your dataset before pushing live in under three working days.
          </p>
        </div>
      </div>
