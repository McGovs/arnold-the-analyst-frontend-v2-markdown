        ...
        <main className="pt-20 pb-16 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">3.1 Core Service Delivery</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">3.2 Service Improvement</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">3.3 Communication</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">3.4 Legal Compliance</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">We do not sell, rent, or trade your personal information. We share information only in the following limited circumstances:</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">4.1 Service Providers</h3>
              <p className="text-slate-700 mb-2">We use trusted third-party service providers to help operate Arnold:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">4.2 Legal Requirements</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">4.3 Business Transfers</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">4.4 With Your Consent</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">We implement appropriate technical and organizational security measures to protect your information:</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">5.1 Encryption</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">5.2 Access Controls</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">5.3 Infrastructure Security</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">6.1 Active Users</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">6.2 Inactive Users</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
                <li><strong>Disconnected Accounts:</strong> If you disconnect Arnold using <code className="bg-slate-100 px-1 py-0.5 rounded text-sm">/arnold-disconnect</code>, we delete your Google OAuth tokens immediately and delete all associated query logs within <strong>30 days</strong></li>
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">6.3 Legal Retention</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">6.4 Manual Deletion</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">Depending on your location, you may have certain rights regarding your personal information:</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.1 Access and Portability</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.2 Correction</h3>
              <p className="text-slate-700 mb-4">
                You have the right to request correction of inaccurate or incomplete personal information.
              </p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.3 Deletion</h3>
              <p className="text-slate-700 mb-2">You have the right to request deletion of your personal information, subject to certain legal exceptions. You can:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
                <li>Use <code className="bg-slate-100 px-1 py-0.5 rounded text-sm">/arnold-disconnect</code> in Slack to immediately disconnect your Google Analytics account</li>
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.4 Objection and Restriction</h3>
              <p className="text-slate-700 mb-4">
                You have the right to object to or request restriction of certain processing activities.
              </p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.5 Withdraw Consent</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">7.6 Lodge a Complaint</h3>
              <p className="text-slate-700 mb-4">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-2">We ensure that appropriate safeguards are in place for international transfers:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">If you are located in the European Economic Area (EEA), UK, or Switzerland, the following additional provisions apply:</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">9.1 Legal Basis for Processing</h3>
              <p className="text-slate-700 mb-2">We process your personal data under the following legal bases:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">9.2 Data Protection Officer</h3>
              <p className="text-slate-700 mb-4">
                For GDPR-related inquiries, please contact: cian@arnoldtheanalyst.com
              </p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">9.3 Your GDPR Rights</h3>
              <p className="text-slate-700 mb-2">In addition to the rights listed in Section 7, you have:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">If you are a California resident, the California Consumer Privacy Act (CCPA) provides you with specific rights:</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">10.1 Categories of Information Collected</h3>
              <p className="text-slate-700 mb-2">As detailed in Section 2, we collect:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">10.2 Your CCPA Rights</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">10.3 Exercising Your Rights</h3>
              <p className="text-slate-700 mb-4">
                To exercise your CCPA rights, contact cian@arnoldtheanalyst.com. We will verify your identity before processing requests.
              </p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">10.4 Do Not Sell</h3>
              <p className="text-slate-700 font-medium">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">11.1 Website Cookies</h3>
              <p className="text-slate-700 mb-2">Our website (arnoldtheanalyst.com) uses essential cookies to:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">11.2 Slack Integration</h3>
              <p className="text-slate-700 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">11.3 Managing Cookies</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-2">If we introduce paid features in the future, we will:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">We may update this privacy policy from time to time to reflect changes in our practices, technology, legal requirements, or other factors.</p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">15.1 Notification of Changes</h3>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800">15.2 Continued Use</h3>
              <p className="text-slate-700 mb-4">
                Your continued use of Arnold after any changes to this privacy policy constitutes your acceptance of the updated policy.
              </p>

              <h3 className="text-lg font-semibold mb-2 text-slate-800">15.3 Review Policy</h3>
              <p className="text-slate-700">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-2">Arnold is designed and intended exclusively for business and professional use. By using Arnold, you represent that:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">If you have questions, concerns, or requests regarding this privacy policy or our data practices, please contact us:</p>
              <p className="text-slate-700 mb-4">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">For clarity, the following terms used in this privacy policy have the following meanings:</p>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg mb-6">
              ...
              <p className="text-slate-700 mb-3">Arnold complies with the following data protection frameworks and regulations:</p>
              <ul className="text-slate-700 list-disc list-inside space-y-1 mb-4">
