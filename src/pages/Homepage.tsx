      ...
      <main className="pt-24 pb-4 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl tracking-tight leading-normal mb-5">
            <span className="text-slate-900 font-bold">What if you could talk to your Google Analytics data?</span>
            <br />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-slate-600">
                Cut time to insight by 90%. Your queries are answered in 20 seconds on average.
              </p>
            </div>
