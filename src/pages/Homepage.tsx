      ...
      <main className="pt-24 pb-4 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative max-w-xl mx-auto mb-5">
            ...
            <div className="absolute -top-3 -right-3 w-16 h-16 bg-blue-500/10 rounded-full blur-2xl" />
            <div className="absolute -bottom-3 -left-3 w-20 h-20 bg-indigo-500/10 rounded-full blur-2xl" />
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-slate-600">
                Ask questions the way you would ask a colleague. No SQL or
                technical GA4 knowledge needed.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-slate-600">
                Cut time to insights by over 90%. Your questions are answered in
            ...
            <div className="text-center p-6">
              ...
              <p className="text-slate-600">
                Managers and marketers do not have to wait on analysts. Analysts
