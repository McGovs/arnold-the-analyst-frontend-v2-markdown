      ...
      >
        ...
        <main className="pt-20 pb-16 px-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-10">
            ...
            {[
              { q: "How do I install Arnold in my Slack workspace?", a: "Go to the top navigation bar or the homepage and click the 'Try Arnold Free In Slack' button. You need admin rights for your Slack workspace." },
