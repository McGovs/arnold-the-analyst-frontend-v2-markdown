...
export default function SlackInstallButton({ className = "" }: SlackInstallButtonProps) {
  ...
  return (
    <a
      ...
      onClick={handleClick}
      className={className || "hidden sm:inline-flex items-center gap-2 bg-white text-slate-800 px-3 py-1.5 rounded border border-slate-300 text-sm font-bold hover:bg-slate-50 transition-colors shadow-sm"}
    >
