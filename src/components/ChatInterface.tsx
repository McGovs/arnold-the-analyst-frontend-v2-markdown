    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Get accurate, actionable insights that cannot be answered by the GA4 UI in minutes.</p>
        </div>
                ...
                <div className="text-center text-gray-500 mt-8">
                  ...
                  <div className="mt-4 text-xs text-left bg-gray-50 p-3 rounded-lg">
                    ...
                    <ul className="space-y-1">
                      ...
                      <li>
                        • "In December 2020, what proportion of cross-device buyers, (i.e. users who made separate purchases on separate device types), purchased on mobile and afterwards, purchased on one or more other device types. How does their average order value compare to mobile only buyers?" - <strong>2 to 3 mins</strong>
                      </li>
                    </ul>
